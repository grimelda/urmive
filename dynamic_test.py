...
windmolens = pd.read_excel('data/windmolens.xlsx')

AvgLs = windmolens['lifespan']

#%%
#AvgLs = 10 * ((0.0164 * x) - 31.8)
#AvgLs = 25*np.ones(len(windmolens['year']))
...
sf.PlotResponse(IOS, windmolens['stock'], figs=True)
